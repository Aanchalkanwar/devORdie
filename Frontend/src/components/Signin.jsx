...
import signinBg from '../assets/images/backgroundHome.jpg'
    ...
    <div style={styles.body}>
      ...
      <div style={styles.container} className="signin-container">
        <div style={styles.content} className="signin-content">
          <h2 style={styles.logo}>Web Weavers</h2>
          ...
          <div style={{ marginTop: '20px' }}>
            ...
            <p style={styles.description}>
              MedRanger is your smart health companion, sending timely reminders so you never miss a dose and stay on top of your medication schedule.
            </p>
