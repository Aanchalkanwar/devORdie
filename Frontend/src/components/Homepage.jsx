...
import back from '../assets/images/img.jpg';
    ...
    <div style={styles.body}>
      ...
      <div style={styles.header}>
        <nav style={styles.nav}>
          <h2 style={styles.sideText}>Web Weavers</h2>
        ...
        <div style={styles.headerContent}>
          ...
          <h3 style={styles.h3}>Your health, always on schedule with MedRanger</h3>
      ...
      <section id="contact" style={styles.contact}>
        ...
        <p>
          ...
          <a href="mailto:support@medranger.com" style={styles.contactLink}>
            support@medranger.com
          </a>
        </p>
      </section>
      ...
      <footer style={styles.footer}>
        <p>© 2025 MedRanger | Built by Web weavers</p>
      </footer>
    </div>
  );
};
