...
const AboutUs = () => {
  ...
  const styles = {
    ...
    gradientSection: {
      width: '100%',
      height: '50vh',
      background: 'linear-gradient(135deg, #09d2a3ff, #09d2a3ff)',
      display: 'flex',
      alignItems: 'center',
        ...
        <div style={styles.contentWrapper}>
          ...
          <div style={styles.mission}>
            ...
            <p style={styles.missionParagraph}>
              At MedRanger, we believe staying healthy should be effortless. Our mission is to help users manage their medications and never miss a dose again. 💊💚
            </p>
            <p style={styles.missionParagraph}>
