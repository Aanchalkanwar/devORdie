...
const AddMedicine = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Validation
    if (!pillName || !dosage || !frequency || selectedDays.length === 0 || !time) {
      ...
      <div style={styles.container}>
        ...
        <div style={styles.mainContent}>
          <div style={styles.editCard}>
            <div style={styles.cardHeader}>
              ...
              <h2 style={styles.cardTitle}>Add New Medication</h2>
              <p style={styles.cardSubtitle}>Enter your medication details</p>
            </div>
        ...
        <div style={{ ...styles.chatBox, ...(showChat ? styles.chatBoxShow : {}) }}>
          ...
          <div style={styles.chatFooter}>
            ...
            <button
              ...
              style={{ padding: '10px 16px', background: 'linear-gradient(135deg, #667eea 0%, #764ba2 100%)', border: 'none', borderRadius: '20px', fontSize: '18px', cursor: 'pointer', color: 'white' }}
            >
              📤
            </button>
          </div>
        ...
        <div style={{ ...styles.modalOverlay, ...(showConfirmModal ? styles.modalOverlayShow : {}) }}>
          <div style={styles.modal}>
            ...
            <h3 style={styles.modalTitle}>Add This Medication?</h3>
            <p style={styles.modalText}>Are you sure you want to add this medication to your list?</p>
        ...
        <div style={{ ...styles.modalOverlay, ...(showSuccessModal ? styles.modalOverlayShow : {}) }}>
          <div style={styles.modal}>
            ...
            <p style={styles.modalText}>Your medication has been added successfully.</p>
            <div style={styles.modalActions}>
              <button
